...
const MOCK_NEWS: NewsItem[] = [
  {
    ...
    excerpt:
      "Nuestras chicas remontaron un 0-2 en contra para llevarse el derbi en un tie-break de infarto. El pabellón vibró con el punto final.",
    icon: Trophy,
  },
  {
    id: 2,
    ...
    excerpt:
      "¿Quieres formar parte del Rayo? Ya puedes apuntarte a nuestras escuelas deportivas y equipos federados. ¡Plazas limitadas!",
    icon: Users,
  },
  {
    id: 3,
    ...
    excerpt:
      "Consulta la asignación de pistas y horas para todas las categorías. Los cambios serán efectivos a partir del próximo lunes.",
    icon: Clock,
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto mb-16 flex flex-col md:flex-row items-end justify-between border-b border-white/10 pb-8 gap-6">
        ...
        {/* CAMBIO: Usamos Link en lugar de button */}
        <Link
          to="/noticias"
          className="hidden md:flex items-center gap-2 text-white font-bold uppercase tracking-wider text-sm hover:text-[#FF6B95] transition-colors group"
        >
        ...
        <div className="mt-12 text-center md:hidden">
          <Link
            to="/noticias"
            className="inline-flex items-center gap-2 text-white font-bold uppercase tracking-wider text-sm hover:text-[#FF6B95] transition-colors"
          >
            Ver todas las noticias
